...
function collectInventory() {
  ...
  return {
    ...
    env: {
      ...
      LAMPY_FAMILY_MEDIA_PATH: envPresence('LAMPY_FAMILY_MEDIA_PATH'),
      ...
      LAMPY_FAMILY_ACCEPT_HOSTED_DATABASE_PATH: envPresence('LAMPY_FAMILY_ACCEPT_HOSTED_DATABASE_PATH'),
      LAMPY_FAMILY_ACCEPT_HOSTED_VOLUME_ROOT: envPresence('LAMPY_FAMILY_ACCEPT_HOSTED_VOLUME_ROOT'),
      LAMPY_FAMILY_ACCEPT_VOLUME_PROBE: envPresence('LAMPY_FAMILY_ACCEPT_VOLUME_PROBE'),
      LAMPY_FAMILY_ACCEPT_VOLUME_AFTER_RESTART: envPresence('LAMPY_FAMILY_ACCEPT_VOLUME_AFTER_RESTART'),
